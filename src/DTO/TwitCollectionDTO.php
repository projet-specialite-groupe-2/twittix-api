...
class TwitCollectionDTO
{
    public function __construct(#[ApiProperty]
        ...
        public string $authorId, #[ApiProperty]
        public string $authorEmail, #[ApiProperty]
        public string $authorUsername, #[ApiProperty]
        public string $authorProfileImgPath, #[ApiProperty]
